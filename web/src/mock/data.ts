...
export const artifacts: Artifact[] = [
  ...
  },
  {
    ...
    body:
      ...
      '<div style="border:1px solid hsl(var(--border));border-radius:10px;padding:12px"><div style="display:flex;gap:8px;align-items:center"><span style="width:28px;height:28px;border-radius:7px;display:grid;place-items:center;background:#0a66c2;color:white;font-weight:800">in</span><strong><a href="https://www.linkedin.com/in/arlan-rakhmetzhanov/" target="_blank" rel="noopener noreferrer">LinkedIn</a></strong></div><p>Arlan profile, current Nozomio role, Stanford AI lab overlap, one-hop paths through Sarah Chen.</p><code>arlan rakhmetzhanov linkedin nozomio stanford cobra</code></div>' +
      '<div style="border:1px solid hsl(var(--border));border-radius:10px;padding:12px"><div style="display:flex;gap:8px;align-items:center"><span style="width:28px;height:28px;border-radius:7px;display:grid;place-items:center;background:#111;color:white;font-weight:800">X</span><strong><a href="https://x.com/arlanrakh" target="_blank" rel="noopener noreferrer">X / social</a></strong></div><p>Launch thread, follower spike, developer replies asking for private-repo indexing and fresh-doc context.</p><code>nozomio nia launch private repos agent context</code></div>' +
      '<div style="border:1px solid hsl(var(--border));border-radius:10px;padding:12px"><div style="display:flex;gap:8px;align-items:center"><span style="width:28px;height:28px;border-radius:7px;display:grid;place-items:center;background:#146aff;color:white;font-weight:800">CB</span><strong><a href="https://www.crunchbase.com/organization/nozomio" target="_blank" rel="noopener noreferrer">Crunchbase</a></strong></div><p>co-investors: <strong>CRV</strong> lead $4M · <strong>BoxGroup</strong> $750k · <strong>LocalGlobe</strong> $750k · angels: Paul Graham, Thomas Wolf, Sam Altman SAFE. <em style="opacity:.65">(modeled — round detail not all public)</em></p><code>nozomio seed crv boxgroup localglobe paul graham thomas wolf altman</code></div>' +
      '<div style="border:1px solid hsl(var(--border));border-radius:10px;padding:12px"><div style="display:flex;gap:8px;align-items:center"><span style="width:28px;height:28px;border-radius:7px;display:grid;place-items:center;background:#24292f;color:white;font-weight:800">GH</span><strong><a href="https://github.com/arlanrakh" target="_blank" rel="noopener noreferrer">GitHub</a></strong></div><p>repos: <a href="https://github.com/arlanrakh/cobra-static" target="_blank" rel="noopener noreferrer"><code>@arlanrakh/cobra-static</code></a>, <a href="https://github.com/arlanrakh/nia-context" target="_blank" rel="noopener noreferrer"><code>@arlanrakh/nia-context</code></a>, <a href="https://github.com/arlanrakh/agent-ctx-bench" target="_blank" rel="noopener noreferrer"><code>@arlanrakh/agent-ctx-bench</code></a>. 47 commits last 30 days, 4 of which are weekend pushes — solo cadence.</p><code>arlanrakh github cobra-static nia-context agent-ctx-bench</code></div>' +
      '<div style="border:1px solid hsl(var(--border));border-radius:10px;padding:12px"><div style="display:flex;gap:8px;align-items:center"><span style="width:28px;height:28px;border-radius:7px;display:grid;place-items:center;background:#d9892f;color:white;font-weight:800">N</span><strong><a href="https://www.nozomio.com" target="_blank" rel="noopener noreferrer">Nozomio docs / site</a></strong></div><p>Nia positioned as context infrastructure, not a coding assistant. Source types: docs, papers, datasets, private repos.</p><code>nozomio nia api docs papers datasets private repos</code></div>' +
      ...
      '<h3>recent posts</h3>' +
      '<div style="display:grid;gap:10px">' +
      '<div style="border:1px solid hsl(var(--border));border-radius:10px;padding:12px"><div style="font-weight:700"><a href="https://x.com/arlanrakh/status/1820000000000000001" target="_blank" rel="noopener noreferrer">X · launch thread "introducing nia · context for coding agents"</a></div><div style="color:hsl(var(--muted-foreground));font-size:12.5px">3 days ago — wedge is private repo + fresh docs, not assistant ux.</div></div>' +
      '<div style="border:1px solid hsl(var(--border));border-radius:10px;padding:12px"><div style="font-weight:700"><a href="https://www.youtube.com/results?search_query=arlan+rakhmetzhanov+nozomio+nia" target="_blank" rel="noopener noreferrer">YouTube · interview on the round</a></div><div style="color:hsl(var(--muted-foreground));font-size:12.5px">1 week ago — cobra → nia framing is rehearsed and crisp.</div></div>' +
      '<div style="border:1px solid hsl(var(--border));border-radius:10px;padding:12px"><div style="font-weight:700"><a href="https://news.ycombinator.com/from?site=nozomio.com" target="_blank" rel="noopener noreferrer">Hacker News · top comment by founder</a></div><div style="color:hsl(var(--muted-foreground));font-size:12.5px">2 weeks ago — fresh-context-for-agents thread; competing claims call out cursor + pinecone limits.</div></div>' +
      '<div style="border:1px solid hsl(var(--border));border-radius:10px;padding:12px"><div style="font-weight:700"><a href="https://www.nozomio.com/blog/context-windows-vs-context-retrieval" target="_blank" rel="noopener noreferrer">Personal blog · "context windows vs context retrieval"</a></div><div style="color:hsl(var(--muted-foreground));font-size:12.5px">3 weeks ago — this is the thesis post, not marketing.</div></div>' +
      '</div>' +
      '<h3>synthesis</h3>' +
    ...
    citations: [
      { kind: 'web',    url: 'https://www.linkedin.com/in/arlan-rakhmetzhanov/', title: 'Arlan Rakhmetzhanov · LinkedIn', summary: 'founder profile, Stanford AI lab, current Nozomio role.' },
      { kind: 'web',    url: 'https://x.com/arlanrakh', title: 'X / @arlanrakh', summary: 'launch thread + dev replies on private-repo and fresh-doc context.' },
      { kind: 'web',    url: 'https://www.crunchbase.com/organization/nozomio', title: 'Nozomio · Crunchbase', summary: 'seed round, investor graph, headcount.' },
      { kind: 'github', url: 'https://github.com/arlanrakh', title: 'github.com/arlanrakh', summary: '47 commits last 30d across cobra-static, nia-context, agent-ctx-bench.' },
      { kind: 'github', url: 'https://github.com/arlanrakh/cobra-static', title: 'arlanrakh/cobra-static', summary: 'stanford research lineage — static analysis precursor to nia.' },
      { kind: 'github', url: 'https://github.com/arlanrakh/nia-context', title: 'arlanrakh/nia-context', summary: 'commercial generalization — context api for coding agents.' },
      { kind: 'web',    url: 'https://www.nozomio.com', title: 'Nozomio · site & docs', summary: 'nia positioned as context infrastructure, not assistant.' },
      { kind: 'web',    url: 'https://www.ycombinator.com/companies/nozomio', title: 'Nozomio · YC S25', summary: 'YC S25 batch listing.' },
      { kind: 'web',    url: 'https://news.ycombinator.com/from?site=nozomio.com', title: 'Hacker News · nozomio threads', summary: 'fresh-context-for-agents discussion, founder top comment.' },
      { kind: 'web',    url: 'https://www.youtube.com/results?search_query=arlan+rakhmetzhanov+nozomio+nia', title: 'YouTube · founder interview on the round', summary: 'cobra → nia framing, rehearsed and crisp.' },
      { kind: 'web',    url: 'https://www.nozomio.com/blog/context-windows-vs-context-retrieval', title: 'Blog · context windows vs context retrieval', summary: 'thesis post — the wedge in the founder\'s words.' },
    ],
  },
  {
    id: 'n7',
